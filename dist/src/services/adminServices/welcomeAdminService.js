...
const sendWelcomeEmail = (email, password) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    ...
    if (userFound) {
        const sendMail = (transporter, email) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
