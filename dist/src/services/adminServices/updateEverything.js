...
const getAllBatchesServices_1 = __importDefault(require("../l_and_d_Services/getAllBatchesServices"));
const traineesByBatchIdServices_1 = __importDefault(require("../l_and_d_Services/traineesByBatchIdServices"));
const individualTraineeProgress_1 = __importDefault(require("../TraineeServices/individualTraineeProgress"));
const getDaywiseCourseServices_1 = __importDefault(require("../TraineeServices/getDaywiseCourseServices"));
const getDayTraineeProgress_1 = __importDefault(require("../TraineeServices/getDayTraineeProgress"));
const updateTraineeCurrentDayService_1 = __importDefault(require("../TraineeServices/updateTraineeCurrentDayService"));
...
// updateCurrentDayController();
const testRun = (res) => __awaiter(void 0, void 0, void 0, function* () {
    const batchReport = yield batchPercipio();
    console.log(batchReport);
    const updateDayReport = yield updateCurrentDay();
    return res.status(200).json({ message: batchReport + " | " + updateDayReport });
});
// testRun();
