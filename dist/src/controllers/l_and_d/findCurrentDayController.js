...
const getWokingDaysInclSaturdayServices_1 = __importDefault(require("../../services/l_and_d_Services/getWokingDaysInclSaturdayServices"));
    ...
    try {
        ...
        if (!batch_id || !current_date)
            return res.status(404).json({
                message: "Missing Fields! Make sure Batch ID and Current Date is Present",
            });
        ...
        if (findBatch) {
            ...
            if (include_saturdays) {
                dayDateMappingList = (0, getWokingDaysInclSaturdayServices_1.default)(start_date, end_date);
            }
            else {
                dayDateMappingList = (0, getWorkingDaysServices_1.default)(start_date, end_date);
            }
