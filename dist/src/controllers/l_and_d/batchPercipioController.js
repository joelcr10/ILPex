...
const batchPercipioController = (req, res) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const traineeList = [];
        yield Promise.all(batchDetails.map((item) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
        ...
        yield Promise.all(traineeList.map((student) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
