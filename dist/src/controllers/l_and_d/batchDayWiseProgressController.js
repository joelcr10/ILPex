...
const findBatchDayWiseProgressService_1 = tslib_1.__importDefault(require("../../services/l_and_d_Services/batchDayWiseProgress/findBatchDayWiseProgressService"));
...
const getDayCountService_1 = tslib_1.__importDefault(require("../../services/l_and_d_Services/batchDayWiseProgress/getDayCountService"));
// Initialize an empty object to store progress data
let progressData = {};
const getBatchDayWiseProgress = (req, res) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    try {
