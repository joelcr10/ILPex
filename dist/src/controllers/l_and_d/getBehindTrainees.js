...
const traineeNamesService_1 = tslib_1.__importDefault(require("../../services/l_and_d_Services/traineeNamesService"));
...
const getIncompleteTraineeListForDay = (req, res) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    try {
