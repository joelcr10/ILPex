...
const calculateTraineeStatus = async (
    trainee_id: number,
    courseSetId: number
): Promise<dayCardType[]> => {
...
export default calculateTraineeStatus;
